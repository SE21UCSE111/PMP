...
from myapp.views import sign_up_and_login, logout_view, list_professors,ProfessorUpdateView, create_project,professor_projects, view_projects, create_team, validate_student,get_student_projects, get_professor_teams, update_grade, decline_team, fetch_project_grades,  manage_todolist, get_todolist,  post_comment, get_comments, accept_team
urlpatterns = [
    ...
    path('api/accept_team/', accept_team, name='accept_team'),
path('api/project/<int:project_id>/grades/', fetch_project_grades, name='fetch_project_grades'),
    ...
    path('api/get_comments/<int:team_id>/', get_comments, name='get_comments'),
    path('api/post_comment/', post_comment, name='post_comment'),
