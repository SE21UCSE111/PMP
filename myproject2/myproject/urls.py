...
from myapp.views import sign_up_and_login, logout_view, list_professors,ProfessorUpdateView, create_project,professor_projects, view_projects, create_team, validate_student,get_student_projects, get_professor_teams, update_grade, decline_team
urlpatterns = [
