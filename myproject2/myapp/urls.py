...
from .views import (
    ...
    view_projects,
    create_team,
    validate_student,get_student_projects, get_professor_teams, update_grade, decline_team, fetch_project_grades, get_todolist, manage_todolist, post_comment, get_comments, accept_team
    )
