    ...
    if request.method == 'POST':
        if request.user.is_authenticated:
            try:
                ...
                # Check if the project has the team associated
                project_teams = project.teams.all()  # Get all teams associated with this project
                for team in project_teams:
                    print(f"Team with {team.members.count()} members")  # You can also log this information for debugging
...
def get_professor_teams(request):
    ...
    for project in projects:
        ...
        if teams.exists():  # Only include projects with teams
            # Instead of team names, we can provide a count of members in the team
            teams_data = []
            for team in teams:
            ...
            projects_data.append({
                ...
                'teams': teams_data  # List of teams with members
            })
